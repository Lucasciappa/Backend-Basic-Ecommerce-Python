...
def Menu_us(user,bank):
    ...
    while(continuar):
        opcionCorrecta=False
        while(not opcionCorrecta):
            print(f"Nombre: {user.get_nombre()} ================= Billetera: ${bank.get_balance()} ====")
            print("========================= INICIO ======================")           
...
def agregue_pro():
    ...
    if validator.validar_pro(form_pro) == {}:
        ...
        p1=Producto(0,form_pro["nombre"],form_pro["precio"],form_pro["categoria"],form_pro["marca"])
